...
workspace_folder = r"PATH TO YOUR WORKSPACE FOLDER" # by default C:\secretservice\workspace\chatbot
new_message_file = os.path.join(workspace_folder, "chatbot_new.txt")
response_file = os.path.join(workspace_folder, "chatbot_message.txt")
status_file = os.path.join(workspace_folder, "chatbot_status.txt")
new_message_status_file = os.path.join(workspace_folder, "chatbot_new_status.txt")
